        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DocumentVerifiedStatus = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SalaryDisbursements_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "UserId");
                });
            ...
            migrationBuilder.InsertData(
                table: "Banks",
                columns: new[] { "BankId", "BankAddress", "BankName" },
                values: new object[] { 1, "MUMBAI", "HDFC BANK" });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "UserId", "BankId", "ClientStatus", "CompanyName", "Email", "Password", "UserAddress", "UserName", "UserType" },
                values: new object[,]
                {
                    { 1, 1, null, null, "Rohit12@Gmail.com", "Rohit@123", null, "Rohit", "SuperAdmin" },
                    { 2, 1, null, null, "Uday123@G", "Uday@123", null, "Uday", "BankUser" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SalaryDisbursements_UserId",
                table: "SalaryDisbursements",
                column: "UserId");
